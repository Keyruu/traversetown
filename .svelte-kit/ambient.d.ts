...
declare module '$env/static/private' {
	export const npm_config__flowable_registry: string;
	...
	export const CXX_x86_64_unknown_linux_gnu: string;
	...
	export const npm_config___artifacts_flowable_com_artifactory_api_npm_flowable_npm_all__username: string;
	...
	export const CC_x86_64_unknown_linux_gnu: string;
	...
	export const CARGO_TARGET_X86_64_UNKNOWN_LINUX_MUSL_LINKER: string;
	...
	export const HELM_EXPERIMENTAL_OCI: string;
	...
	export const npm_config___artifacts_flowable_com_artifactory_api_npm_flowable_npm_all__email: string;
	...
	export const npm_config___artifacts_flowable_com_artifactory_api_npm_flowable_npm_all__always_auth: string;
	...
	export const AR_x86_64_unknown_linux_gnu: string;
	export const npm_package_files_1: string;
	export const npm_package_files_0: string;
	export const npm_config__bryntum_registry: string;
	export const CONDA_CHANGEPS1: string;
	export const DISABLE_FZF_AUTO_COMPLETION: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		npm_config__flowable_registry: string;
		...
		CXX_x86_64_unknown_linux_gnu: string;
		...
		npm_config___artifacts_flowable_com_artifactory_api_npm_flowable_npm_all__username: string;
		...
		CC_x86_64_unknown_linux_gnu: string;
		COMMAND_MODE: string;
		...
		CARGO_TARGET_X86_64_UNKNOWN_LINUX_MUSL_LINKER: string;
		PATH: string;
		...
		npm_config___artifacts_flowable_com_artifactory_api_npm_flowable_npm_all__email: string;
		...
		npm_config___artifacts_flowable_com_artifactory_api_npm_flowable_npm_all__always_auth: string;
		...
		AR_x86_64_unknown_linux_gnu: string;
		npm_package_files_1: string;
		npm_package_files_0: string;
		npm_config__bryntum_registry: string;
		CONDA_CHANGEPS1: string;
		DISABLE_FZF_AUTO_COMPLETION: string;
