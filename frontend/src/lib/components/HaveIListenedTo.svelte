			...
			unsubscribe = playcount().subscribe(({ data, error }) => {
				if (data != null) {
					...
					if (lowerArtist === 'brakence') {
						...
						comment = 'keshi is probably my second favorite artist! I love his music!';
					} else if (playcountValue > 2000) {
						comment = 'I love them! They are in my top 10!';
					} else if (playcountValue > 1000) {
						comment = 'Oh boy! This is an awesome artist! Probably in my top 20.';
						...
						comment = "I don't really know about them... Maybe I should listen to them more?";
					} else {
						comment = 'Yeah...';
					}
				} else if (error) {
...
<div class="flex justify-center items-center flex-col">
	<h1 class="text-3xl m-8">Type in an artist and see if I have listened to them:</h1>
