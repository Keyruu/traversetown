...
const { show } = storeToRefs(navStore)
...
<template>
  <div>
    ...
    <nav class="bg-[#121212] z-50 fixed w-screen">
      <div v-show="show" class="grid grid-cols-3 lg:grid-cols-5 grid-rows-1 gap-1">
        ...
        <div class="flex justify-center items-center">
          <NuxtLink to="/">
            <NuxtImg class="logo w-44 my-4 drop-shadow visible" width="500" height="300" :placeholder="[500, 300]"
              sizes="xs:20vw sm:30vw md:50vw lg:100vw" src="/keyruu_logo.png" alt="Keyruu" @mouseenter="() => focus(2)"
              @mouseleave="reset" />
          </NuxtLink>
        </div>
        ...
        <div class="flex justify-center items-center lg:hidden">
          <UButton variant="link" class="h-8 w-8" icon="i-mdi-menu" @click="slideoverOpen = true" />
        </div>
      </div>
    </nav>
      ...
      <div class="bg-zinc-800">
        <div class="mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row items-center">
          ...
          <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            <IconLink icon="i-mdi-github" link="https://github.com/Keyruu" iconColor="#6b7280" highlightColor="#fff"
              extraClasses="ml-3" :do-focus="false" />
            <IconLink icon="i-mdi-linkedin" link="https://www.linkedin.com/in/lucasrott/" iconColor="#6b7280"
              highlightColor="#3375b0" extraClasses="ml-3" :do-focus="false" />
            <IconLink icon="i-mdi-discord" link="https://discord.gg/XYUmUeFwA7" iconColor="#6b7280"
              highlightColor="#5865F2" extraClasses="ml-3" :do-focus="false" />
            <IconLink icon="i-mdi-instagram" link="https://www.instagram.com/iamkeyruu/?hl=de" iconColor="#6b7280"
              highlightColor="#e1306c" extraClasses="ml-3" :do-focus="false" />
          </span>
        </div>
      </div>
    </footer>
